...
This repository only contains the source code of the 2-D convectional simulation. These codes are written on the basis of the codes provided by ASPECT, and follows the same protocl as the codes in ASPECT.
